...
class DuckDbInetLpmIndex:
    ...
    ```
        ...
        idx = DuckDbInetLpmIndex.load(
            Path("cache/"), value_cols=("is_proxy", "proxy_type"),
        )
    ```
    """
    ...
    def save(self, directory: Path) -> Path:
        ...
        Writes to ``directory / <auto-generated name>``.
        The filename is derived from the value columns
        (e.g. ``DuckDbInetLpmIndex_is_proxy_proxy_type.msgpack``).
    ...
    @classmethod
    def load(cls, directory: Path, value_cols: Tuple[str, ...] = ()) -> "DuckDbInetLpmIndex":
        """Load a previously saved index from disk.

        Reads from ``directory / <auto-generated name>``.
        *value_cols* is used to derive the filename (same logic as ``save()``).
        """
        path = directory / cls._resolve_cache_name(value_cols)
